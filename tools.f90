...
implicit none
	...
	logical :: ifZo,ifMod,ifAl,ifBlazko,ifRem
	
ifZo=.false.; ifMod=.false.; ifAl=.false.; ifBlazko=.false.; ifRem=.false.
...
implicit none
	...
	logical :: ifTrend,ifSignalAt2
	
ifTrend=.false.; ifSignalAt2=.false.
